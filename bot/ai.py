...
async def generate_workout_via_ai(user):
    ...
    prompt = (
        ...
        f"Для каждого упражнения обязательно указывай вес (даже если это собственный вес — пиши явно). После плана тренировки выдай отдельным абзацем совет по питанию на сегодня.\n"
