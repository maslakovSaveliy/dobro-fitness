...
async def generate_workout_via_ai(user):
    ...
    prompt = (
        f"Ты - профессиональный фитнесс-тренер. Генерируй разнообразный персональный план тренировок для пользователя с учётом его цели, уровня, ограничений, частоты тренировок, роста, веса, возраста и пола.\n"
